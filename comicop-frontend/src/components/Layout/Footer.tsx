        ...
        <>
            <div className="bg-gray-600 py-1">
                <div className="container mx-auto px-4">
                    ...
                    {[
                        { icon: '🚚', title: 'Miễn phí ship', sub: 'Đơn từ 150.000đ' },
                        { icon: '🔄', title: 'Đổi trả dễ dàng', sub: 'Trong vòng 7 ngày' },
                        { icon: '✅', title: 'Hàng chính hãng', sub: '100% authentic' },
                        { icon: '💳', title: 'Thanh toán COD', sub: 'Nhận hàng mới trả' },
                    ].map((item, i) => (
            ...
            <footer className="bg-gray-800 text-white">
                <div className="container mx-auto px-4 py-8">
                    ...
                    <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-400">
                        <p>&copy; {new Date().getFullYear()} ComicopStore. All rights reserved.</p>
                    </div>
                </div>
            </footer>
        </>    
